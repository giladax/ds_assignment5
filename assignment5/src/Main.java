...
public class Main {
	...
	private static void testA() {
		Point[] points = { new Point(0, 0), new Point(3, 1), new Point(2, 3),
				new Point(1, 2), new Point(4, 4), };
		...
		testName = "A3.1";
		Point[] expectedPoints1 = { new Point(1, 2), };
		testExpectedPoints(testName, expectedPoints1, pdt.getMedianPoints(1));
		testName = "A3.2";
		Point[] expectedPoints2 = { new Point(3, 1), new Point(1, 2), };
		testExpectedPoints(testName, expectedPoints2, pdt.getMedianPoints(2));
		testName = "A3.3";
		Point[] expectedPoints3 = { new Point(3, 1), new Point(2, 3),
				new Point(1, 2), };
		testExpectedPoints(testName, expectedPoints3, pdt.getMedianPoints(3));

		Point[] points2 = { new Point(1, 4), new Point(2, 7), new Point(3, 15),
				new Point(7, 7), new Point(8, 2), new Point(9, 9),
				new Point(12, 5), new Point(13, 7), new Point(15, 15),
				new Point(35, 12), };
		...
		XLeft = 12;
		XRight = 100;
		Point[] expectedLargePoints = { new Point(12, 5), new Point(13, 7),
				new Point(15, 15), new Point(35, 12), };
		testExpectedPoints(testName, expectedLargePoints,
				pdt.getPointsInRange(XLeft, XRight));
		...
		testName = "A7.1";
		Point[] expectedPoints4 = { new Point(13, 7), };
		testExpectedPoints(testName, expectedPoints4, pdt.getMedianPoints(1));
		testName = "A7.2";
		Point[] expectedPoints5 = { new Point(7, 7), new Point(13, 7), };
		testExpectedPoints(testName, expectedPoints5, pdt.getMedianPoints(2));
		testName = "A7.3";
		Point[] expectedPoints6 = { new Point(7, 7), new Point(13, 7),
				new Point(9, 9), };
		testExpectedPoints(testName, expectedPoints6, pdt.getMedianPoints(3));
		testName = "A7.4";
		Point[] expectedPoints7 = { new Point(2, 7), new Point(7, 7),
				new Point(13, 7), new Point(9, 9), };
		testExpectedPoints(testName, expectedPoints7, pdt.getMedianPoints(4));
		testName = "A7.5";
		Point[] expectedPoints8 = { new Point(2, 7), new Point(7, 7),
				new Point(13, 7), new Point(9, 9), new Point(35, 12), };
	...
	private static void testB() {
		...
		XRight = 12;
		testName = "B3";
		Point[] expectedPoints1 = { new Point(7, NUM - 7 - 1),
				new Point(8, NUM - 8 - 1), new Point(9, NUM - 9 - 1),
				new Point(10, NUM - 10 - 1), new Point(11, NUM - 11 - 1),
				new Point(12, NUM - 12 - 1), };
		testExpectedPoints(testName, expectedPoints1,
				pdt.getPointsInRange(XLeft, XRight));

		int k = 6;
		testName = "B4";
		int mid = NUM / 2;
		Point[] expectedPoints2 = { new Point(NUM - mid - 1, mid),
		...
		testName = "B5";
		Point[] expectedPoints3 = { new Point(NUM - mid - 1, mid),
				new Point(NUM - (mid - 1) - 1, mid - 1),
				new Point(NUM - (mid + 1) - 1, mid + 1),
				new Point(NUM - (mid - 2) - 1, mid - 2),
				new Point(NUM - (mid + 2) - 1, mid + 2),
				new Point(NUM - (mid - 3) - 1, mid - 3),
				new Point(NUM - (mid + 3) - 1, mid + 3), };
		testExpectedPoints(testName, expectedPoints3,
				pdt.getMedianPoints(k + 1));

		pdt.addPoint(new Point(NUM, NUM));

		testName = "B6.1";
		Point[] expectedPoints4 = { new Point(NUM - mid - 1, mid),
				new Point(NUM - (mid - 1) - 1, mid - 1),
				new Point(NUM - (mid + 1) - 1, mid + 1),
				new Point(NUM - (mid - 2) - 1, mid - 2),
				new Point(NUM - (mid + 2) - 1, mid + 2),
		...
		testName = "B6.2";
		Point[] expectedPoints5 = { new Point(NUM - mid - 1, mid),
				new Point(NUM - (mid - 1) - 1, mid - 1),
				new Point(NUM - (mid + 1) - 1, mid + 1),
				new Point(NUM - (mid - 2) - 1, mid - 2),
				new Point(NUM - (mid + 2) - 1, mid + 2),
				new Point(NUM - (mid - 3) - 1, mid - 3),
				new Point(NUM - (mid + 3) - 1, mid + 3), };
		testExpectedPoints(testName, expectedPoints5,
				pdt.getMedianPoints(k + 1));
		...
		testExpectedPoints(testName, expectedPoints7,
				pdt.getMedianPoints(k + 1));
	}

	private static void testC() {
		Point[] points = { new Point(43, 694), new Point(157, 2672),
				new Point(216, 912), new Point(231, 491), new Point(251, 879),
				new Point(261, 1991), new Point(268, 2203),
				new Point(360, 1507), new Point(385, 2437),
				new Point(392, 1188), new Point(400, 357),
				new Point(416, 1167), new Point(473, 2307),
				new Point(614, 577), new Point(629, 2662),
				new Point(630, 2155), new Point(649, 2131),
				new Point(722, 1140), new Point(727, 2502),
				new Point(729, 730), new Point(789, 2652), new Point(826, 841),
				new Point(1013, 818), new Point(1026, 174),
				new Point(1029, 2576), new Point(1228, 2382),
				new Point(1398, 1588), new Point(1476, 1135),
				new Point(1493, 43), new Point(1513, 1017),
				new Point(1534, 1586), new Point(1569, 324),
				new Point(1578, 857), new Point(1780, 2080),
				new Point(1783, 3), new Point(1829, 2522),
				new Point(1839, 2256), new Point(1867, 41),
				new Point(1907, 751), new Point(2044, 2004),
				new Point(2071, 1120), new Point(2076, 992),
				new Point(2094, 572), new Point(2150, 1019),
				new Point(2174, 1157), new Point(2226, 1404),
				new Point(2238, 721), new Point(2286, 2570),
				new Point(2338, 583), new Point(2476, 960), };

		PDT pdt = new PointDataStructure(points, points[17]);

		String testName_median_array_23 = "median median_array_23";
		Point[] median_array_23 = { new Point(1013, 818), new Point(826, 841),
				new Point(1578, 857), new Point(251, 879), new Point(216, 912),
				new Point(2476, 960), new Point(2076, 992),
				new Point(1513, 1017), new Point(2150, 1019),
				new Point(2071, 1120), new Point(1476, 1135),
				new Point(722, 1140), new Point(2174, 1157),
				new Point(416, 1167), new Point(392, 1188),
				new Point(2226, 1404), new Point(360, 1507),
				new Point(1534, 1586), new Point(1398, 1588),
				new Point(261, 1991), new Point(2044, 2004),
				new Point(1780, 2080), new Point(649, 2131), };

		testExpectedPoints(testName_median_array_23, median_array_23,
				pdt.getMedianPoints(23));

		String testName_median_array_7 = "median median_array_7";
		Point[] median_array_7 = { new Point(2150, 1019),
				new Point(2071, 1120), new Point(1476, 1135),
				new Point(722, 1140), new Point(2174, 1157),
				new Point(416, 1167), new Point(392, 1188), };

		testExpectedPoints(testName_median_array_7, median_array_7,
				pdt.getMedianPoints(7));

		String testName_median_array_5 = "median median_array_5";
		Point[] median_array_5 = { new Point(2071, 1120),
				new Point(1476, 1135), new Point(722, 1140),
				new Point(2174, 1157), new Point(416, 1167), };

		testExpectedPoints(testName_median_array_5, median_array_5,
				pdt.getMedianPoints(5));

		String testName_median_array_6 = "median median_array_6";
		Point[] median_array_6 = { new Point(2150, 1019),
				new Point(2071, 1120), new Point(1476, 1135),
				new Point(722, 1140), new Point(2174, 1157),
				new Point(416, 1167), };

		testExpectedPoints(testName_median_array_6, median_array_6,
				pdt.getMedianPoints(6));

		String testName_median_array_9 = "median median_array_9";
		Point[] median_array_9 = { new Point(1513, 1017),
				new Point(2150, 1019), new Point(2071, 1120),
				new Point(1476, 1135), new Point(722, 1140),
				new Point(2174, 1157), new Point(416, 1167),
				new Point(392, 1188), new Point(2226, 1404), };

		testExpectedPoints(testName_median_array_9, median_array_9,
				pdt.getMedianPoints(9));

		String testName_median_array_17 = "median median_array_17";
		Point[] median_array_17 = { new Point(251, 879), new Point(216, 912),
				new Point(2476, 960), new Point(2076, 992),
				new Point(1513, 1017), new Point(2150, 1019),
				new Point(2071, 1120), new Point(1476, 1135),
				new Point(722, 1140), new Point(2174, 1157),
		...
		testExpectedPoints(testName_median_array_17, median_array_17,
				pdt.getMedianPoints(17));

		String testName_median_array_19 = "median median_array_19";
		Point[] median_array_19 = { new Point(1578, 857), new Point(251, 879),
				new Point(216, 912), new Point(2476, 960),
				new Point(2076, 992), new Point(1513, 1017),
				new Point(2150, 1019), new Point(2071, 1120),
				new Point(1476, 1135), new Point(722, 1140),
				new Point(2174, 1157), new Point(416, 1167),
				new Point(392, 1188), new Point(2226, 1404),
				new Point(360, 1507), new Point(1534, 1586),
				new Point(1398, 1588), new Point(261, 1991),
				new Point(2044, 2004), };

		testExpectedPoints(testName_median_array_19, median_array_19,
				pdt.getMedianPoints(19));

		String testName_median_array_12 = "median median_array_12";
		Point[] median_array_12 = { new Point(2476, 960), new Point(2076, 992),
				new Point(1513, 1017), new Point(2150, 1019),
				new Point(2071, 1120), new Point(1476, 1135),
				new Point(722, 1140), new Point(2174, 1157),
				new Point(416, 1167), new Point(392, 1188),
		...
		testExpectedPoints(testName_median_array_12, median_array_12,
				pdt.getMedianPoints(12));

		String testName_median_array_8 = "median median_array_8";
		Point[] median_array_8 = { new Point(1513, 1017),
				new Point(2150, 1019), new Point(2071, 1120),
				new Point(1476, 1135), new Point(722, 1140),
				new Point(2174, 1157), new Point(416, 1167),
				new Point(392, 1188), };

		testExpectedPoints(testName_median_array_8, median_array_8,
				pdt.getMedianPoints(8));

		String testName_median_array_13 = "median median_array_13";
		Point[] median_array_13 = { new Point(2476, 960), new Point(2076, 992),
				new Point(1513, 1017), new Point(2150, 1019),
				new Point(2071, 1120), new Point(1476, 1135),
				new Point(722, 1140), new Point(2174, 1157),
				new Point(416, 1167), new Point(392, 1188),
		...
		testExpectedPoints(testName_median_array_13, median_array_13,
				pdt.getMedianPoints(13));

		String testName_median_array_21 = "median median_array_21";
		Point[] median_array_21 = { new Point(826, 841), new Point(1578, 857),
				new Point(251, 879), new Point(216, 912), new Point(2476, 960),
				new Point(2076, 992), new Point(1513, 1017),
				new Point(2150, 1019), new Point(2071, 1120),
				new Point(1476, 1135), new Point(722, 1140),
				new Point(2174, 1157), new Point(416, 1167),
				...
				new Point(360, 1507), new Point(1534, 1586),
				new Point(1398, 1588), new Point(261, 1991),
				new Point(2044, 2004), new Point(1780, 2080), };

		testExpectedPoints(testName_median_array_21, median_array_21,
				pdt.getMedianPoints(21));

		String testName_median_array_3 = "median median_array_3";
		Point[] median_array_3 = { new Point(1476, 1135), new Point(722, 1140),
				new Point(2174, 1157), };

		testExpectedPoints(testName_median_array_3, median_array_3,
				pdt.getMedianPoints(3));
		...
		Point[] median_array_8_mew = { new Point(392, 1188),
				new Point(1824, 1244), new Point(135, 1332),
				new Point(2226, 1404), new Point(360, 1507),
				new Point(1205, 1811), new Point(1278, 1838),
				new Point(663, 1892), };

		Point[] pp = new Point[] { new Point(1, 1), new Point(5, 1),
				new Point(12, 2), new Point(20, 1), new Point(27, 2),
				new Point(33, 2), new Point(41, 2) };
		...
		numInRange = pdt.numOfPointsInRange(Integer.MIN_VALUE,
				Integer.MAX_VALUE);
	...
	private static <T> void testExpected(String testName, T expected, T actual) {
		if (!actual.equals(expected)) {
			System.out.println("Test " + testName + ": wrong! expected="
	...
	private static void testExpectedPoints(String testName,
			Point[] expectedPoints, Point[] actualPoints) {
		if (!equalAsSets(actualPoints, expectedPoints)) {
			System.out.println("Test " + testName + ": wrong! expected="
					+ Arrays.toString(expectedPoints) + ", actual="
	...
	// NOTE: if one of the sets contains 2 points with same coordinates, might
	// return erroneous result
	private static boolean equalAsSets(Point[] actualPoints,
		...
		for (int i = 0; i < expectedPoints.length; i++) {
			...
			for (int j = 0; j < actualPoints.length; j++) {
				if (expectedPoints[i].equals(actualPoints[j]))
					exists = true;
			}
			if (!exists)
				return false;
